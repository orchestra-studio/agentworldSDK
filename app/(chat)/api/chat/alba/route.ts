...
import { albaSystemPrompt } from "@/lib/ai/prompts/alba";
import { myProvider } from "@/lib/ai/providers";
import { albaTools } from "@/lib/ai/orchestrator/alba";
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Unhandled error in Alba chat API:", error, { vercelId });
